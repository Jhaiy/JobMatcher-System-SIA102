...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save-about'])) {
    $company_id = $_SESSION['CompanyID'];
    $company_bio = $_POST['my-bio'];
    $company_about = $_POST['about-me'];
    $company_bio = mysqli_real_escape_string($link, $company_bio);
    $company_about = mysqli_real_escape_string($link, $company_about);
    $update_bio = "UPDATE companydetails SET CompanyBio = '$company_bio', CompanyAbout = '$company_about' WHERE CompanyDetailsID = '$company_id'";
...
$company_profile_query = "SELECT CompanyBio, CompanyAbout FROM companydetails WHERE CompanyDetailsID = ?";
$stmt = mysqli_prepare($link, $company_profile_query);
...
$bio = isset($bio_data['CompanyBio']) ? $bio_data['CompanyBio'] : '';
$background = isset($bio_data['CompanyAbout']) ? $bio_data['CompanyAbout'] : '';
?>
...
<head>
    ...
    <link rel="stylesheet" href="employer-profile-style.css">
                ...
                <form method="post" action="employer-profile-page.php">
                    ...
                    <div class="about-applicant-wrapper">
                        ...
                        <div class="applicant-about">
                            ...
                            <textarea id="about-me" name="about-me" rows="4" cols="50" placeholder="About your company"
